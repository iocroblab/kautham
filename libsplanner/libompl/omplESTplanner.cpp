 ...
 */
  namespace omplplanner{
    ...
    //! Constructor
    omplESTPlanner::omplESTPlanner(SPACETYPE stype, Sample *init, Sample *goal, SampleSet *samples, Sampler *sampler, WorkSpace *ws, LocalPlanner *lcPlan, KthReal ssize):
