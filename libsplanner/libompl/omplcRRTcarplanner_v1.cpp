...
#include "omplcRRTcarplanner_v1.h"
...
namespace libPlanner {
  ...
  public:
      ...
      void operator()(const ob::State *state, const oc::Control *control, std::valarray<double> &dstate) const
      {
          ...
          //dstate[0] = -u[0] * sin(theta*2*M_PI);
          //dstate[1] = -u[0] * cos(theta*2*M_PI);
  ...
  public:
      ...
      DemoControlSpace(const ob::StateSpacePtr &stateSpace, int d) : oc::RealVectorControlSpace(stateSpace, d)
      {
      }
  };
 ...
 // space =  ((ob::StateSpacePtr) new ob::SE2StateSpace());
  ...
  //space->as<ob::SE2StateSpace>()->setBounds(bounds);
        ...
        int numcontrols = 2;
        spacec = ((oc::ControlSpacePtr) new DemoControlSpace(space,numcontrols));
        ...
        ss->setStateValidityChecker(boost::bind(&omplcplannerV1::isStateValid, ss->getSpaceInformation().get(), _1, (Planner*)this));
