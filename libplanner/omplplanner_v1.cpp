...
namespace libPlanner {
  ...
  bool isStateValid(const ob::State *state, Planner *p)//, Sample *smp)
  {
	...
	//! Constructor
    omplPlannerV1::omplPlannerV1(SPACETYPE stype, Sample *init, Sample *goal, SampleSet *samples, Sampler *sampler, WorkSpace *ws, LocalPlanner *lcPlan, KthReal ssize):
	...
	//! void destructor
    omplPlannerV1::~omplPlannerV1(){
			
	}
	
	//! setParameters sets the parameters of the planner
    bool omplPlannerV1::setParameters(){
      try{
    ...
    SoSeparator *omplPlannerV1::getIvCspaceScene()
    {
