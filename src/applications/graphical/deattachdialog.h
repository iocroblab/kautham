...
namespace Kautham {
    ...
    */
    ...
    /*!
    * \brief The DeattachDialog class allows the user to attach objects to robot links
    */
    class DeattachDialog : public QDialog {
        Q_OBJECT
    public:
        /*!
         * \brief DeattachDialog Constructs the dialog
         * \param parent Parent of the dialog
         * \param f Window flags
         */
        DeattachDialog(QWidget *parent = 0, Qt::WindowFlags f = 0);
