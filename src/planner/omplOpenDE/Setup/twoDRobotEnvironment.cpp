...
twoDRobotEnvironment::twoDRobotEnvironment(WorkSpace* ws, double maxspeed, double maxContacts, double minControlSteps,double maxControlSteps, double erp, double cfm,bool isKchain):KauthamDEEnvironment(ws, maxspeed,maxContacts,minControlSteps,maxControlSteps, erp, cfm, isKchain)
{
