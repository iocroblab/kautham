...
#include <kautham/planner/omplOpenDE/Setup/KUKAEnvironment.h>
...
unsigned int KUKAEnvironment::getControlDimension(void) const
{
    ...
    return wkspace->getNumRobControls();
}
...
{
    //xml value
    for(int i=0; i < wkspace->getNumRobControls(); i++)
    {
        lower[i]=-0.2;
        upper[i]= 0.2;
    }
...
void KUKAEnvironment::applyControl(const double *control) const
{
    ...
    dJointSetAMotorParam(motor_.at("kuka_lwr_pg70_gripperbase+kuka_lwr_pg70_gripperlink1"), dParamVel, (control[0]));
    dJointSetAMotorParam(motor_.at("kuka_lwr_pg70_gripperbase+kuka_lwr_pg70_gripperlink1"), dParamFMax, 150);

    dJointSetAMotorParam(motor_.at("kuka_lwr_pg70_gripperlink1+kuka_lwr_pg70_gripperlink2"), dParamVel, (control[1]));
    dJointSetAMotorParam(motor_.at("kuka_lwr_pg70_gripperlink1+kuka_lwr_pg70_gripperlink2"), dParamFMax, 150);

    dJointSetAMotorParam(motor_.at("kuka_lwr_pg70_gripperlink2+kuka_lwr_pg70_gripperlink3"), dParamVel, control[2]);
    dJointSetAMotorParam(motor_.at("kuka_lwr_pg70_gripperlink2+kuka_lwr_pg70_gripperlink3"), dParamFMax, 150);

    dJointSetAMotorParam(motor_.at("kuka_lwr_pg70_gripperlink3+kuka_lwr_pg70_gripperlink4"), dParamVel, (control[3]));
    dJointSetAMotorParam(motor_.at("kuka_lwr_pg70_gripperlink3+kuka_lwr_pg70_gripperlink4"), dParamFMax, 150);

    dJointSetAMotorParam(motor_.at("kuka_lwr_pg70_gripperlink4+kuka_lwr_pg70_gripperlink5"), dParamVel, (control[4]));
    dJointSetAMotorParam(motor_.at("kuka_lwr_pg70_gripperlink4+kuka_lwr_pg70_gripperlink5"), dParamFMax,150);

    dJointSetAMotorParam(motor_.at("kuka_lwr_pg70_gripperlink5+kuka_lwr_pg70_gripperlink6"), dParamVel, 0);
    dJointSetAMotorParam(motor_.at("kuka_lwr_pg70_gripperlink5+kuka_lwr_pg70_gripperlink6"), dParamFMax, 150);

    dJointSetAMotorParam(motor_.at("kuka_lwr_pg70_gripperlink6+kuka_lwr_pg70_gripperlink7"), dParamVel, control[6]);
    dJointSetAMotorParam(motor_.at("kuka_lwr_pg70_gripperlink6+kuka_lwr_pg70_gripperlink7"), dParamFMax, 150);

    dJointSetLMotorParam(motor_.at("kuka_lwr_pg70_grippergripper+kuka_lwr_pg70_gripperfinger1"), dParamVel, 0);
    dJointSetLMotorParam(motor_.at("kuka_lwr_pg70_grippergripper+kuka_lwr_pg70_gripperfinger1"), dParamFMax, 100);

    dJointSetLMotorParam(motor_.at("kuka_lwr_pg70_grippergripper+kuka_lwr_pg70_gripperfinger2"), dParamVel, 0);
    dJointSetLMotorParam(motor_.at("kuka_lwr_pg70_grippergripper+kuka_lwr_pg70_gripperfinger2"), dParamFMax, 100);
...
KUKAStateValidityChecker::KUKAStateValidityChecker(const oc::SpaceInformationPtr &si):oc::OpenDEStateValidityChecker(si)
{
...
bool KUKAStateValidityChecker::isValid(const ob::State *state) const
{
...
KUKAStateSpace::KUKAStateSpace(const oc::OpenDEEnvironmentPtr &env, Planner *planner) : oc::OpenDEStateSpace(env)
{
    _planner=planner;
}
...
double KUKAStateSpace::distance(const ob::State *s1, const ob::State *s2) const
{
    ...
    {
        for(unsigned int i=0;i<_planner->wkSpace()->getRobot(0)->getNumLinks()-2;i++)
        {
...
///////////////////////////////////////////////////////////////////
KukaControlSampler::KukaControlSampler(const oc::ControlSpace *cm, Planner *planner) : oc::RealVectorControlUniformSampler(cm)
{
...
void KukaControlSampler::sample(oc::Control *control)
{
...
KukaControlSpace::KukaControlSpace(const ob::StateSpacePtr &m, Planner *planner) : oc::OpenDEControlSpace(m)
{
    _planner=planner;
}
oc::ControlSamplerPtr KukaControlSpace::allocControlSampler(void) const
{
    return oc::ControlSamplerPtr(new KukaControlSampler(this,_planner));
}
