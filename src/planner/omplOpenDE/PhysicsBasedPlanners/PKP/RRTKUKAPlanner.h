...
#if !defined(_RRTKUKAPlanner_H)
#define _RRTKUKAPlanner_H
...
{
    class RRTKUKAPlanner: public KauthamDEPlanner
    {
    public:
        //! The constructor will define all the necessary parameters for planning.
        RRTKUKAPlanner(SPACETYPE stype, Sample *init, Sample *goal, SampleSet *samples, WorkSpace *ws);
        ~RRTKUKAPlanner();
