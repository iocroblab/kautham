...
#include "KPIECEMultiRobotPlanner.h"
 ...
 */
KPIECEMultiRobotPlanner::KPIECEMultiRobotPlanner(SPACETYPE stype, Sample *init, Sample *goal, SampleSet *samples, WorkSpace *ws):
      KauthamDEPlanner(stype, init, goal, samples, ws)
  {
      //set intial values from parent class data
      _guiName = "KPIECE Multi Robot Planner";
      _idName = "KPIECEMultiRobotPlanner";
       dInitODE2(0);


       oc::OpenDEEnvironmentPtr envPtr(new MultiRobotEnvironment (ws,_maxspeed,_maxContacts,_minControlSteps,_maxControlSteps, _erp, _cfm));
...
//! void destructor
  KPIECEMultiRobotPlanner::~KPIECEMultiRobotPlanner(){

  }
//! this function set the necessary parameters for KAPIECE Planner.
  bool KPIECEMultiRobotPlanner::setParameters()
  {
