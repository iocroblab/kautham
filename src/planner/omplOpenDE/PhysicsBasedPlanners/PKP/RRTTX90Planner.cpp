...
namespace omplcplanner{
  ...
  //! void destructor
  RRTTX90Planner::~RRTTX90Planner(){

  }

   RRTTX90Planner::RRTTX90Planner(SPACETYPE stype, Sample *init, Sample *goal, SampleSet *samples, WorkSpace *ws) : KauthamDEPlanner(stype, init, goal, samples, ws)
   {


     _guiName = "RRT TX90 Planner";
     _idName = "RRTTX90Planner";
     //ws->moveRobotsTo(init);
     dInitODE2(0);
      envPtr = oc::OpenDEEnvironmentPtr(new TX90Environment(ws,_maxspeed,_maxContacts,_minControlSteps,_maxControlSteps, _erp, _cfm, _isKchain));
...
//     planner->as<oc::KPIECE1>()->setGoalBias(_GoalBias);
 ...
 bool RRTTX90Planner::setParameters()
 {
