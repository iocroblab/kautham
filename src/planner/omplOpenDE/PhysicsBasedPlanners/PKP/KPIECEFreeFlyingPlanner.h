...
#if !defined(_KPIECE3DPlanner_H)
#define _KPIECE3DPlanner_H
#define dDOUBLE

#include "../KauthamOpenDEPlanner.h"
#include "../../environment/SimpleRobotEnvironment/FreeFlyingRobotEnvironment.h"
...
class KPIECE3DPlanner: public KauthamDEPlanner
{
public:
    //! Constructor create dynamic enviroment and setup all the necessary parameters for planning.
    KPIECE3DPlanner(SPACETYPE stype, Sample *init, Sample *goal, SampleSet *samples, WorkSpace *ws);
    ~KPIECE3DPlanner();
