...
#if !defined(_KPIECEKUKAPlanner_H)
#define _KPIECEKUKAPlanner_H
...
#include "../../environment/SimpleRobotEnvironment/KUKAEnvironment.h"
...
{
    class KPIECEKUKAPlanner: public KauthamDEPlanner
    {
    public:
        //! The constructor will define all the necessary parameters for planning.
        KPIECEKUKAPlanner(SPACETYPE stype, Sample *init, Sample *goal, SampleSet *samples, WorkSpace *ws);
        ~KPIECEKUKAPlanner();
