...
//#if !defined(_TestEnvironment_H)
//#define _TestEnvironment_H
//#define dDOUBLE
...
// class KauthamDE2RobotEnvironment: public KauthamDEEnvironment
// {
//     public:

//     KauthamDE2RobotEnvironment(WorkSpace* ws, KthReal maxspeed, KthReal maxContacts, KthReal minControlsteps,KthReal maxControlsteps, KthReal erp, KthReal cfm);//!< Constructor define the robot environment(i.e. table environment ) by calling the KauthamDEEnvironment.
//     ~KauthamDE2RobotEnvironment(void);
...
// */
//class KauthamDE2RobotStateSpace : public KauthamDEStateSpace
//{
//private:

//public:
//    KauthamDE2RobotStateSpace(const oc::OpenDEEnvironmentPtr &env);//!< Constructor
//    ~KauthamDE2RobotStateSpace();
...
// */
//class KauthamDE2RobotStateProjectionEvaluator: public KauthamDEStateProjectionEvaluator
//{

//public:
//    KauthamDE2RobotStateProjectionEvaluator(const ob::StateSpace *space); //!< Constructor
