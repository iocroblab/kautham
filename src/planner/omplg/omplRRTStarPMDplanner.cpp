...
namespace Kautham {
   ...
   */
        ob::OptimizationObjectivePtr omplRRTStarPMDPlanner::createOptimizationObjectivePMD()
        {
        ...
        //! Constructor
        omplRRTStarPMDPlanner::omplRRTStarPMDPlanner(SPACETYPE stype, Sample *init, Sample *goal, SampleSet *samples, WorkSpace *ws, og::SimpleSetup *ssptr):
        ...
        //! void destructor
        omplRRTStarPMDPlanner::~omplRRTStarPMDPlanner(){

        }

        bool omplRRTStarPMDPlanner::setPotentialCost(string filename) {
        ...
        bool omplRRTStarPMDPlanner::trySolve()
        {
            bool ret;
            //solve
        ...
        bool omplRRTStarPMDPlanner::setParameters() {
