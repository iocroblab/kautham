...
namespace Kautham {
    namespace omplplanner{
        omplFOSLBKPIECE1Planner::Projection::Projection(const ompl::base::StateSpacePtr &space,
            ...
            std::cout << "FOS LBKPIECE Projection" << std::endl;
            proj.print("proj");
            offset.print("offset");
            low.print("low");
            high.print("high");
        ...
        unsigned int omplFOSLBKPIECE1Planner::Projection::getDimension() const {
            return proj.n_rows;
        }

        void omplFOSLBKPIECE1Planner::Projection::defaultCellSizes() {
        ...
        void omplFOSLBKPIECE1Planner::Projection::project(const ompl::base::State *state,
        ...
        void omplFOSLBKPIECE1Planner::Projection::omplState2armaVec(const ompl::base::State *s,
                                                                    arma::vec &q) const {
            q.resize(vfdim_);
            unsigned int k = 0;
        ...
        //! Constructor
        omplFOSLBKPIECE1Planner::omplFOSLBKPIECE1Planner(SPACETYPE stype, Sample *init, Sample *goal,
            ...
            _guiName = "ompl FOSLBKPIECE1 Planner";
            _idName = "omplFOSLBKPIECE1";
            ...
            og::FOSLBKPIECE1 *planner = new og::FOSLBKPIECE1(si,this,st_);

            ob::ProjectionEvaluatorPtr projEv(new omplFOSLBKPIECE1Planner::Projection(space,this,st_));
            projEv->setup();
        ...
        //! void destructor
        omplFOSLBKPIECE1Planner::~omplFOSLBKPIECE1Planner(){

        }


        //! function to find a solution path
        bool omplFOSLBKPIECE1Planner::trySolve()
        {
        ...
        bool omplFOSLBKPIECE1Planner::setParameters(){
            omplPlanner::setParameters();
            try {
                HASH_S_K::iterator it;
                og::FOSLBKPIECE1 *planner = ss->getPlanner()->as<og::FOSLBKPIECE1>();
