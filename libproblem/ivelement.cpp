            ...
            if(input.openFile(collision_ivfile.c_str())) {
                ...
                if (num_triangles < 4) {
                    ...
                    if (vertex_rank < 3 || !valid_num_triangles(num_triangles,num_vertices)) {
                        ...
                        collision_ivmodel->addChild(myCoords);
                        ...
                        collision_ivmodel->addChild(myFaceSet);

                        //save collision_ivmodel in a new file
                        ofstream bbox_file;
                        bbox_file.open(collision_ivfile.c_str(),ios_base::out | ios_base::trunc);
