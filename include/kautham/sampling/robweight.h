 ...
 */
  ...
  public:
      ...
      inline void                   setSE3Weight(double t, double r){_se3[0] = t;_se3[1] = r;}
      inline double*               getSE3Weight(){return _se3;}
      inline std::vector<double>&  getRnWeights(){return _rn;}
      void                          setRnWeigh(unsigned int i, double w);
  private:
