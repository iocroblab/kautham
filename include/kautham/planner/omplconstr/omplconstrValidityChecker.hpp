...
#if !defined(_omplconstrVALIDITYCHECKER_H)
#define _omplconstrVALIDITYCHECKER_H
    ...
    namespace omplconstrplanner{
        ...
        class ValidityChecker : public ob::StateValidityChecker {
            private:
                ...
                // bool isUnconstrainedPartValid(const ob::State* state, const Sample* smp) const;
...
#endif  //_omplconstrVALIDITYCHECKER_H
