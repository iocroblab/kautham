...
namespace Kautham {
    namespace omplplanner {
        class omplFOSTRRTPlanner:public omplPlanner {
        public:
            omplFOSTRRTPlanner(SPACETYPE stype, Sample *init, Sample *goal,
                                   SampleSet *samples, WorkSpace *ws, og::SimpleSetup *ssptr);

            virtual ~omplFOSTRRTPlanner();
