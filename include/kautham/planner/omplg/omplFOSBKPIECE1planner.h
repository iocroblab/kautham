...
#ifndef OMPLFOSBKPIECE1PLANNER_H
#define OMPLFOSBKPIECE1PLANNER_H
 ...
 */
    namespace omplplanner {
        class omplFOSBKPIECE1Planner : public omplPlanner {
        public:
            omplFOSBKPIECE1Planner(SPACETYPE stype, Sample *init, Sample *goal,
                                   SampleSet *samples, WorkSpace *ws, og::SimpleSetup *ssptr,
                                   const std::string &synergyTreeFilename);

            ~omplFOSBKPIECE1Planner();
...
#endif // OMPLFOSBKPIECE1PLANNER_H
