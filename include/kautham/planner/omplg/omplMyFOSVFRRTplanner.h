...
#ifndef OMPLMyFOSVFRRTPLANNER_H
#define OMPLMyFOSVFRRTPLANNER_H
 ...
 */
    namespace omplplanner {
        class omplMyFOSVFRRTPlanner : public omplPlanner {
        public:
            omplMyFOSVFRRTPlanner(SPACETYPE stype, Sample *init, Sample *goal,
                             SampleSet *samples, WorkSpace *ws, og::SimpleSetup *ssptr,
                                const std::string &synergyTreeFilename);

            ~omplMyFOSVFRRTPlanner();
