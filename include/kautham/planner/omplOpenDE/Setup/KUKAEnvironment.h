...
/////////////////////////////////////////////////////////////////////////////////
class KUKAStateValidityChecker : public oc::OpenDEStateValidityChecker
{
public:
    KUKAStateValidityChecker(const oc::SpaceInformationPtr &si);
...
public:
    ...
    KUKAStateSpace(const oc::OpenDEEnvironmentPtr &env, Planner *planner );//!< Constructor
    ~KUKAStateSpace();
...
public:
unsigned int stps;
    KukaControlSampler(const oc::ControlSpace *cm, Planner *planner);
...
public:
    ...
    KukaControlSpace(const ob::StateSpacePtr &m, Planner *planner);
