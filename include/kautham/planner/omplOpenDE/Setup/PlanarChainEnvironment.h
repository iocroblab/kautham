...
public:
    ...
    PlanarChainEnvironment(WorkSpace* ws, double maxspeed, double maxContacts, double minControlsteps,double maxControlsteps, double erp, double cfm,bool isKchain);//!< Constructor define the robot environment(i.e. table environment ) by calling the KauthamDEEnvironment.
