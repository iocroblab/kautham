...
#if !defined(_KPIECECarPlanner_H)
#define _KPIECECarPlanner_H
#define dDOUBLE
...
class KPIECECarPlanner: public KauthamDEPlanner
{
public:
    //! Constructor create dynamic enviroment and setup all the necessary parameters for planning.
    KPIECECarPlanner(SPACETYPE stype, Sample *init, Sample *goal, SampleSet *samples, WorkSpace *ws);
    ~KPIECECarPlanner();
