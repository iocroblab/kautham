...
#if !defined(_KPIECE2DPlanner_H)
#define _KPIECE2DPlanner_H
#define dDOUBLE
...
class KPIECE2DPlanner: public KauthamDEPlanner
{
public:
    //! Constructor create dynamic enviroment and setup all the necessary parameters for planning.
    KPIECE2DPlanner(SPACETYPE stype, Sample *init, Sample *goal, SampleSet *samples, WorkSpace *ws);
    ~KPIECE2DPlanner();
